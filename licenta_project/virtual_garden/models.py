...
class GardenSlot(models.Model):
    ...
    pos_x = models.FloatField(null=True, blank=True, help_text="Pozitia X ca procent")
    pos_y = models.FloatField(null=True, blank=True, help_text="Pozitia Y ca procent")
